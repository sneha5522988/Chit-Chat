...
function Profile() {
  ...
  return (
    <div className="w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]">
      ...
      <div
        className="bg-white rounded-full border-2 border-[#20c7ff] shadow-gray-400 shadow-lg relative"
      ...
      >
        ...
        <div className="absolute bottom-4 text-gray-700 right-3.5 w-[35px] h-[35px] rounded-full border-[#20c7ff] flex justify-center items-center">
          <PiCameraDuotone className="absolute  text-gray-700  w-[25px] h-[25px]" />
        </div>
      </div>
      <form
        className="w-[95%] h-[293px] max-w-[500px] flex flex-col gap-[20px] items-center justify-center"
      ...
      >
        ...
        <input
          ...
          readOnly
          className="w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-[white]
          rounded-lg shadow-gray-300 shadow-lg text-gray-400 text-[19px]"
